/*
    ...
    to load a value into R1
    (LOAD IMMEDIATE)
    0x08800000               load R1, 0 (immediate) 
    0x08800004               load R1, 4 (immediate) (use for BRNZ and BRPL)

    regular LOAD
    load R1, 0(83)          # added some number to line 48 in ram.hex
    0x00800053

    registers default initialize to 0

    when Running the test bench
*/
...
module brzr_tb;
    ...
    parameter   Default = 5'b00000, REG_load1a = 5'b00001, REG_load1b = 5'b00010, REG_load1c = 5'b00011,
                ...
                T7 = 5'b01111; //, T6 = 5'b10000, T7 = 5'b10001;
	...
	always @(Present_state) begin
		case (Present_state)
            ...
            REG_load1a: begin
                #10 in_data <= 32'h0x00800053; InPortIn <= 1;                    

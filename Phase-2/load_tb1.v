...
module load_tb1;
	...
	always @(Present_state) begin
		case (Present_state)
            ...
            Reg_load3a: begin
                #10 write <= 1; in_data <= 32'h0; InPortIn <= 1;        // assert the write signal (and write the value 0x97 to the memory address 0x54)?
            ...
            T7: begin
                #10 MDRout <= 1; Gra <= 1; Rin <= 1;                    // MDR drives the bus

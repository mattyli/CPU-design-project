module phase_3_datapath(
    input wire clock, reset, stop,
    input wire [31:0] in_data,
    output wire [31:0] run,
    input wire [4:0] opcode,
    input wire clear,
    input wire PCout, read, write, BAout, Rin, Rout, Gra, Grb, Grc, CONN_in,
    input wire MARin, MDRin, HIin, LOin, Yin, jal_flag,
    input wire Zin, ZLowIn, ZHighIn, PCin, IRin, incPC, InPortIn, OutPortIn,
    input wire HIout, LOout, ZLowOut, ZHighOut, MDRout, Cout, InPortOut,
    output wire R15jal
);
    ...
    wire [31:0] IRdata;
    wire [31:0] BusMuxOut, Yout, MARout, C_sign_extended;
    ...
    wire [31:0] Mdatain, OutPortOut;

    assign R15jal = Rin | jal_flag;

    // Registers
    regR0 R0 (clear, clock, R0in, BAout, BusMuxOut, BusMuxIn_R0);
    ...
    ram RAM (.clk(clock), .addr(MARout[8:0]), .data_in(BusMuxIn_MDR), .write(write), .read(read), .data_out(Mdatain));
    ...
    bus myBus (
        ...
        .BusMuxIn_R0(BusMuxIn_R0), .BusMuxIn_R1(BusMuxIn_R1), .BusMuxIn_R2(BusMuxIn_R2), .BusMuxIn_R3(BusMuxIn_R3),
        .BusMuxIn_R4(BusMuxIn_R4), .BusMuxIn_R5(BusMuxIn_R5), .BusMuxIn_R6(BusMuxIn_R6), .BusMuxIn_R7(BusMuxIn_R7),
        .BusMuxIn_R8(BusMuxIn_R8), .BusMuxIn_R9(BusMuxIn_R9), .BusMuxIn_R10(BusMuxIn_R10), .BusMuxIn_R11(BusMuxIn_R11),
        .BusMuxIn_R12(BusMuxIn_R12), .BusMuxIn_R13(BusMuxIn_R13), .BusMuxIn_R14(BusMuxIn_R14), .BusMuxIn_R15(BusMuxIn_R15),
        .BusMuxIn_HI(BusMuxIn_HI), .BusMuxIn_LO(BusMuxIn_LO), .BusMuxIn_Zhigh(BusMuxIn_Zhigh), .BusMuxIn_Zlow(BusMuxIn_Zlow),
        .BusMuxIn_PC(BusMuxIn_PC), .BusMuxIn_MDR(BusMuxIn_MDR), .BusMuxIn_InPort(BusMuxIn_InPort),
        .C_sign_extended(C_sign_extended), .BusMuxOut(BusMuxOut)
    );
    ...
    alu myAlu (
        .A(Yout), .B(BusMuxOut), .clock(clock), .clear(clear),
        .opcode(opcode), .incPC(incPC), .CONN_out(branch_flag), .C(C_Register_Out)
    );
